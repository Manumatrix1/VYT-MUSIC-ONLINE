 ...
 * Archivo principal que importa y re-exporta funciones de módulos especializados
...
// Módulo de emails automatizados
...
// Módulos adicionales (habilitados para producción)
...
// 📧 FUNCIONES DE EMAILS (10 funciones)
...
// 💳 FUNCIONES DE PAGOS (6 funciones)
...
// 🎥 FUNCIONES DE YOUTUBE (7 funciones)
...
// 💰 FUNCIONES DE VYT-MONEY Y POZO (9 funciones)
...
exports.onPrizePoolUpdate = vytMoneyModule.onPrizePoolUpdate;
exports.sendVYTMoneyPurchaseConfirmation = vytMoneyModule.sendVYTMoneyPurchaseConfirmation;

// 👨‍💼 FUNCIONES ADMINISTRATIVAS (6 funciones)
exports.sendApprovalEmail = adminModule.sendApprovalEmail;
exports.sendRejectionEmail = adminModule.sendRejectionEmail;
...
console.log(`Loaded modules: emails, payments, youtube, vyt-money, admin`);
console.log(`Total functions exported: 38+`);
console.log(`Architecture: Modular (resolved performance issues)`);