...
exports.enviarCorreoInscripcionOnline = onDocumentCreated(
  ...
  async (event) => {
    ...
    try {
      ...
      console.log(`Correo de inscripción online enviado a: ${data.email}`);
      return null;
    } catch (error) {
  ...
  async (event) => {
    ...
    try {
      ...
      const mailOptions = {
        ...
        html: `
          <h2>📢 ¡Felicitaciones!</h2>
          <p>Tu inscripción presencial ya fue recibida y está siendo evaluada por nuestro equipo. 🙌</p>
      ...
      await transporter.sendMail(mailOptions);
      console.log(`Correo de inscripción presencial enviado a: ${data.email}`);
      return null;
    } catch (error) {
      console.error("Error enviando correo:", error);
      return null;
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p><a href="${siteUrl.value()}/principal.html" style="background-color:#007bff;color:white;padding:12px 25px;text-decoration:none;border-radius:5px;font-weight:bold;">Realizar Pago</a></p>
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p><a href="${siteUrl.value()}/principal.html" style="background-color:#007bff;color:white;padding:12px 25px;text-decoration:none;border-radius:5px;font-weight:bold;">Ver Detalles</a></p>
        <p>¡Gracias por ser parte de VYT Music! 🎤✨</p>
        <p>El equipo de VYT Music</p>
      `
    };
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p><a href="${siteUrl.value()}/principal.html" style="background-color:#007bff;color:white;padding:12px 25px;text-decoration:none;border-radius:5px;font-weight:bold;">Volver al inicio</a></p>
        <p>El equipo de VYT Music</p>
      `
    };
